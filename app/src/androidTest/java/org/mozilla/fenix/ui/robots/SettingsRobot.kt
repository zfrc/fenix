...
//            mDevice.waitForIdle()
        ...
        fun openAccessibilitySubMenu(interact: SettingsSubMenuAccessibilityRobot.() -> Unit): SettingsSubMenuAccessibilityRobot.Transition {
            //            mDevice.waitForIdle()
            fun transitionButton() = onView(ViewMatchers.withText("Accessibility"))
        ...
        fun openDefaultBrowserSubMenu(interact: SettingsSubMenuDefaultBrowserRobot.() -> Unit): SettingsSubMenuDefaultBrowserRobot.Transition {
            //            mDevice.waitForIdle()
            fun transitionButton() = onView(ViewMatchers.withText("Set as default browser"))
            transitionButton().click()
        ...
        fun openSubMenuEnhancedTP(interact: SettingsSubMenuEnhancedTPRobot.() -> Unit): SettingsSubMenuEnhancedTPRobot.Transition {
            //            mDevice.waitForIdle()
            fun transitionButton() = onView(ViewMatchers.withText("Enhanced Tracking Protection"))
            transitionButton().click()
...
//            mDevice.waitForIdle()
            ...
            fun transitionButton() = onView(ViewMatchers.withText("Site permissions"))
            transitionButton().click()
...
//            mDevice.waitForIdle()
            onView(withText(endsWith("Delete browsing data"))).click()

            SettingsSubMenuDeleteBrowsingDataRobot().interact()
            return SettingsSubMenuDeleteBrowsingDataRobot.Transition()
        }

        fun openSubMenuDeleteBrowsingDataOnQuit(interact: SettingsSubMenuDeleteBrowsingDataOnQuitRobot.() -> Unit): SettingsSubMenuDeleteBrowsingDataOnQuitRobot.Transition {
//            mDevice.waitForIdle()
            onView(withText(endsWith("Delete browsing data on quit"))).click()

            SettingsSubMenuDeleteBrowsingDataOnQuitRobot().interact()
            return SettingsSubMenuDeleteBrowsingDataOnQuitRobot.Transition()
        }

        fun openDataCollection(interact: SettingsSubMenuDataCollectionRobot.() -> Unit): SettingsSubMenuDataCollectionRobot.Transition {
//            mDevice.waitForIdle()
            onView(withText(endsWith("Data collection"))).click()
...
private fun assertSearchEngineButton() {
    mDevice.waitNotNull(Until.findObject(By.text("Search")), waitingTime)
...
private fun assertAddPrivateBrowsingShortcutButton() {
    mDevice.waitNotNull(Until.findObject(By.text("Add private browsing shortcut")), waitingTime)
    onView(withText("Add private browsing shortcut"))
        .check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
}
