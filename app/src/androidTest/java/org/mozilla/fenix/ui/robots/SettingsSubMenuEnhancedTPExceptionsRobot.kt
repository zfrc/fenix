...
/**
 * Implementation of Robot Pattern for the Settings menu - Enhanced TP Exeptions sub menu.
 */
...
private fun assertExceptionsDescription() {
    ...
    mDevice.waitNotNull(Until.findObjects(By.text(strExceptions)), TestAssetHelper.waitingTime)
